...
public class Imobiliaria_CauanIgorVinicius {
    ...
    public Imobiliaria_CauanIgorVinicius() {
        ...
        this.alugueis = Configuracao_CauanIgorVinicius.lerObjetos("Trabalho2/arquivos/alugueis.dat");
        this.vendas = Configuracao_CauanIgorVinicius.lerObjetos("Trabalho2/arquivos/vendas.dat");
        this.imoveis = Configuracao_CauanIgorVinicius.lerObjetos("Trabalho2/arquivos/imoveis.dat");
        this.clientes = Configuracao_CauanIgorVinicius.lerObjetos("Trabalho2/arquivos/clientes.dat");
        this.corretores = Configuracao_CauanIgorVinicius.lerObjetos("Trabalho2/arquivos/corretores.dat");
        this.seguros = Configuracao_CauanIgorVinicius.lerObjetos("Trabalho2/arquivos/seguros.dat");
    }
    ...
    {
        Configuracao_CauanIgorVinicius.salvarObjetos(alugueis, "Trabalho2/arquivos/alugueis.dat");
        Configuracao_CauanIgorVinicius.salvarObjetos(vendas, "Trabalho2/arquivos/vendas.dat");
        Configuracao_CauanIgorVinicius.salvarObjetos(imoveis, "Trabalho2/arquivos/imoveis.dat");
        Configuracao_CauanIgorVinicius.salvarObjetos(clientes, "Trabalho2/arquivos/clientes.dat");
        Configuracao_CauanIgorVinicius.salvarObjetos(corretores, "Trabalho2/arquivos/corretores.dat");
        Configuracao_CauanIgorVinicius.salvarObjetos(seguros, "Trabalho2/arquivos/seguros.dat");
    }
