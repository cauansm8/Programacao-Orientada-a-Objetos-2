...
public class Imobiliaria_CauanIgorVinicius {
    ...
    public Imobiliaria_CauanIgorVinicius() {
        ...
        this.alugueis = Configuracao_CauanIgorVinicius.lerObjetos("Trabalho1/arquivos/alugueis.dat");
        this.vendas = Configuracao_CauanIgorVinicius.lerObjetos("Trabalho1/arquivos/vendas.dat");
        this.imoveis = Configuracao_CauanIgorVinicius.lerObjetos("Trabalho1/arquivos/imoveis.dat");
        this.clientes = Configuracao_CauanIgorVinicius.lerObjetos("Trabalho1/arquivos/clientes.dat");
        this.corretores = Configuracao_CauanIgorVinicius.lerObjetos("Trabalho1/arquivos/corretores.dat");
        this.seguros = Configuracao_CauanIgorVinicius.lerObjetos("Trabalho1/arquivos/seguros.dat");
    }
    ...
    {
        Configuracao_CauanIgorVinicius.salvarObjetos(alugueis, "Trabalho1/arquivos/alugueis.dat");
        Configuracao_CauanIgorVinicius.salvarObjetos(vendas, "Trabalho1/arquivos/vendas.dat");
        Configuracao_CauanIgorVinicius.salvarObjetos(imoveis, "Trabalho1/arquivos/imoveis.dat");
        Configuracao_CauanIgorVinicius.salvarObjetos(clientes, "Trabalho1/arquivos/clientes.dat");
        Configuracao_CauanIgorVinicius.salvarObjetos(corretores, "Trabalho1/arquivos/corretores.dat");
        Configuracao_CauanIgorVinicius.salvarObjetos(seguros, "Trabalho1/arquivos/seguros.dat");
    }
